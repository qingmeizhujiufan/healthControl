...
namespace CommonTool
{
    public class EnterprisePaymentToUser
    {
        ...
        public static string APPID = CommonTool.Common.GetAppSetting("appIDSR");              //开发者应用ID
        public static string PARTNER = CommonTool.Common.GetAppSetting("mchID");          //商户号
        public static string APPSECRET = CommonTool.Common.GetAppSetting("appSecretSR");      //开发者应用密钥
